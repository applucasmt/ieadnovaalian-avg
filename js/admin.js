...
// Estado local do hero (durante edição)
window.heroState = {
    position: 'center',
    align: 'center',
    posX: 50,
...
// ============================================================
// RENDERIZAR FORM DE CONFIG (com preview completo)
// ============================================================
window.renderConfigForm = (config) => {
    ...
    // Monta o preview com a imagem de fundo
    ...
    container.innerHTML = 
        '<div class="max-w-4xl mx-auto py-4">' +
            ...
            '<div class="mb-6 pb-4 border-b border-white/10">' +
                ...
                '</h3>' +
                '<p class="text-xs text-gray-400 mt-1">Altere a logo, a foto de fundo, a posição e os textos do hero.</p>' +
            '</div>' +

            // ============================================================
            // PREVIEW COMPLETO (com imagem + textos)
            // ============================================================
